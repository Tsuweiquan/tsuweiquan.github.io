...
description: Start of a new journey 🛣️
...
My mindset was wrong where I thought that during my probational period, I should be making impactful changes to prove my worth to the company. I was deep into the mindset of "fixing" things that I thought were wrong.
...
1. I should have used my probation time to focus on analyzing the existing infrastructure setup and question _WHY_ it was done like this. Understand it from a technical perspective to the business needs. Document the reason down and best to always have a diagram drawn for any business flows.
   ...
   - Need to also understand the limitations that influence this design

```
TO BE CONTINUED
2. If i were to rewind time, these are the things I would have done before diving deep into topics.
- Pragmatic Engineer
